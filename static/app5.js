...
function filterObs(){
    ...
    let userName    = nameField.property("value").toLowerCase();
    let userPos    = posField.property("value").toLowerCase();
    let userTeam   = teamField.property("value").toLowerCase();
    ...
    if(userName || userPos || userTeam){
        ...
        // let tableMatch = tableData.filter(obs =>(obs.Name == userName) &&
        //                                         (obs.Pos == userPos) &&
        //                                         (obs.Team == userTeam) );
        // tableMatch = tableData.filter(obs => eval(condition));
...
function resetData(){
    ...
    // reset the form
    document.forms["stats-form"].reset() //check ufo-data name
